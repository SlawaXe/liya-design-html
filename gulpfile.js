...
//-- Config
var config = {
    proxy: 'liya-design.loc/web',
    port: 545,
    browser: 'chrome', // google chrome | firefox | opera
    openBrowser: false, // true | false
    autoprefixLastVer: 4, // 1-4
    path: {
        projectDir: 'web/',
        mainSass: 'assets/sass/style.scss',
        sass: 'assets/sass/**/*.scss',
        css: 'web/',
        js: 'assets/js/',
        jsReady: 'web/js/',
        imgTemp: 'web/img/temp/',
        imgReady: 'web/img/'
    }
};
...
gulp.task('watch', function (done) {
  ...
  gulp.watch(config.path.projectDir + '**/*.html' ).on('change', browserSync.reload);
